...
namespace Kolokwium.Web.Controllers
{
    ...
    {
        private readonly SignInManager<User> _signInManager; private readonly UserManager<User> _userManager; private readonly JwtOptionsVm _jwtOptions;
        public AccountApiController(ILogger logger, IMapper mapper,
